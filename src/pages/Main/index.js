                    ...
                    <ul class="list-unstyled ps-0" style={{marginLeft: '12px'}}>
                        ...
                        <li class="mb-1">
                            ...
                            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                <li><Link to="/search"><div class="link-body-emphasis d-inline-flex text-decoration-none rounded">Advanced Search</div></Link></li>
                                <li><Link><div class="link-body-emphasis d-inline-flex text-decoration-none rounded">Recently Added</div></Link></li>
                                <li><Link><div class="link-body-emphasis d-inline-flex text-decoration-none rounded">Latest Updates</div></Link></li>
                                <li><Link><div class="link-body-emphasis d-inline-flex text-decoration-none rounded">Random</div></Link></li>
                            </ul>
                            </div>
                        </li>
                        <li class="mb-1">
                            ...
                            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                <li><Link to="/"><div class="link-body-emphasis d-inline-flex text-decoration-none rounded">Updates</div></Link></li>
                                <li><Link to="/"><div class="link-body-emphasis d-inline-flex text-decoration-none rounded">Library</div></Link></li>
                                <li><Link to="/"><div class="link-body-emphasis d-inline-flex text-decoration-none rounded">Reading History</div></Link></li>
                            </ul>
                            </div>
                        </li>
                        ...
                        <div class="d-flex align-items-center link-body-emphasis text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu text-small shadow show" style={{position: 'absolute', inset: 'auto auto 0px 0px', margin: '0px', transform: 'translate(0px, -34px)'}} data-popper-placement="top-start">
                                ...
                                <li><Link to="/" style={{textDecoration: 'none'}}><div class="dropdown-item">Sign out</div></Link></li>
                            </ul>
                        </div>
                </div>
                <div class="col-9">
