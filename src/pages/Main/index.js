            ...
            <div class="row">
                <div class="col-3 text-white bg-dark" style={{ height: '100vh'}}>
                    ...
                    <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="https://titles.trackercdn.com/valorant-api/agents/320b2a48-4d9b-a075-30f1-1f93a9b638fa/displayicon.png" alt="" width="32" height="32" class="rounded-circle me-2"/>
                        <strong>Sova</strong>
                    </a>
